// 订单查询
sw.page.modules["bondordermanage/bondOrderQuery"] = sw.page.modules["bondordermanage/bondOrderQuery"] || {
    query: function () {
        ...
        var url = sw.serializeObjectToURL("api/bondordermanage/queryOrder/queryOrderHeadList", {
            ...
            columns: [
                ...
                },
                {
                    ...
                    return '<a style="cursor:pointer" title="订单回执详情信息" ' +
                        'onclick="' + "javascript:sw.pageModule('bondordermanage/bondOrderQuery').returnOrderDetails('" + row.guid + "','" + row.order_No + "')" + '">' + value + '</a>';
                }
                }
            ],
            order: [[1, 'asc']]
