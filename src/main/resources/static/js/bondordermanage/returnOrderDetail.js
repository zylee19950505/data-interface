...
sw.page.modules["bondordermanage/returnOrderDetail"] = sw.page.modules["bondordermanage/returnOrderDetail"] || {
    detailParam: {
        url: "",
        callBackUrl: "",
        isShowError: true,
    ...
    disabledFieldInput: function () {
        var disableField = sw.page.modules["bondordermanage/returnOrderDetail"].detailParam.disableField;
    ...
    query: function () {
        //从路径上找参数
        var param = sw.getPageParams("bondordermanage/returnOrderDetail");
        var guid = param.guid;
        ...
        $.ajax({
            method: "GET",
            url: "api/bondordermanage/queryOrder/returnOrderDetail",
            data: data,
            success: function (data, status, xhr) {
                if (xhr.status == 200) {
                    var entryModule = sw.page.modules["bondordermanage/returnOrderDetail"];
