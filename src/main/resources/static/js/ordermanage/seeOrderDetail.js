...
sw.page.modules["ordermanage/seeOrderDetail"] = sw.page.modules["ordermanage/seeOrderDetail"] || {
    ...
    fillEntryListInfo: function (entryLists) {
        for (var i = 0; i < entryLists.length; i++) {
            ...
            var str = "<tr><td ><input class=\"form-control input-sm\" id='g_num_" + g_num + "' value='" + entryLists[i].g_num + "' /></td>" +//递增序号
                ...
                "<td ><input class=\"form-control input-sm\" maxlength=\"16\" id='note" + g_num + "' value='" + entryLists[i].note + "' /></td></tr>";//促销活动
