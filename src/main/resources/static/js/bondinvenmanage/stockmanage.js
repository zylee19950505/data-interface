//清单查询
sw.page.modules["bondinvenmanage/stockmanage"] = sw.page.modules["bondinvenmanage/stockmanage"] || {
    ...
    query: function () {
        ...
        // 拼接URL及参数
        var url = sw.serializeObjectToURL("api/bondinvenmanage/stockmanage", {
        ...
        // 数据表
        sw.datatable("#query-stockmanage-table", {
            ordering: false,
            bSort: false, //排序功能
