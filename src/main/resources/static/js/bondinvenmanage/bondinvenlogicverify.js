 ...
 */
sw.page.modules["bondinvenmanage/bondinvenlogicverify"] = sw.page.modules["bondinvenmanage/bondinvenlogicverify"] || {
    //查询
    query: function () {
        ...
        sw.datatable("#query-logic-table", {
            ...
            columns: [
                ...
                },
                {
                    ...
                    return '<a href="javascript:void(0)"  onclick="' + "javascript:sw.pageModule('bondinvenmanage/bondinvenlogicverify').seeInventoryLogicDetail('" + row.guid + "','" + row.order_no + "')" + '">' + row.order_no + '</a>'
                }
                },
                {
