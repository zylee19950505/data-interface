//清单查询
sw.page.modules["outInventoryList/createEnterInventoryList"] = sw.page.modules["outInventoryList/createEnterInventoryList"] || {
    ...
    query: function () {
        ...
        // 数据表
        sw.datatable("#query-createEnterInventoryList-table", {
            ordering: false,
            bSort: false, //排序功能
