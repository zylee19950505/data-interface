...
sw.page.modules["deliverymanage/seeDeliveryDetail"] = sw.page.modules["deliverymanage/seeDeliveryDetail"] || {
    detailParam: {
        url: "",
        callBackUrl: "",
        isShowError: true,
    ...
    disabledFieldInput: function () {
        var disableField = sw.page.modules["deliverymanage/seeDeliveryDetail"].detailParam.disableField;
    ...
    saveExitInventoryInfo: function () {
        ...
        sw.ajax(this.detailParam.url, "POST", "entryJson=" + encodeURIComponent(JSON.stringify(entryData)), function (rsp) {
            ...
            if (rsp.data.result) {
                sw.page.modules["deliverymanage/seeDeliveryDetail"].cancel();
                setTimeout(function () {
                    sw.alert(rsp.data.msg, "提示", null, "modal-info");
                }, 500);
                sw.page.modules["deliverymanage/seeDeliveryDetail"].callBackQuery();
            } else {
    ...
    query: function () {
        ...
        $.ajax({
            ...
            success: function (data, status, xhr) {
                if (xhr.status == 200) {
                    var entryModule = sw.page.modules["deliverymanage/seeDeliveryDetail"];
                    ...
                    // headChangeKeyValEInven["entryhead_guid"] = param.billNos;
    ...
    goPage: function (pno, psize) {
        ...
        var tempStr = "";
        if (currentPage > 1) {
            tempStr += "<li class='prev'><a href='javascript:void(0)' onClick=\"sw.page.modules['deliverymanage/seeDeliveryDetail'].goPage(" + (currentPage - 1) + "," + psize + ")\"> 上一页&nbsp;&nbsp;</a><li>";
            for (var j = 1; j <= totalPage; j++) {
                if (currentPage == j) {
                    tempStr += "<li class='active'><a href='javascript:void(0)' onClick=\"sw.page.modules['deliverymanage/seeDeliveryDetail'].goPage(" + j + "," + psize + ")\">" + j + "&nbsp;&nbsp;</a><li>";
                } else if (j == 1 || j == totalPage) {
                    tempStr += "<li><a href='javascript:void(0)' onClick=\"sw.page.modules['deliverymanage/seeDeliveryDetail'].goPage(" + j + "," + psize + ")\">" + j + "&nbsp;&nbsp;</a><li>";
                } else {
                    tempStr += "<li><a hidden='hidden' href='javascript:void(0)' onClick=\"sw.page.modules['deliverymanage/seeDeliveryDetail'].goPage(" + j + "," + psize + ")\">" + j + "&nbsp;&nbsp;</a><li>";
                }
        ...
        if (currentPage < totalPage) {
            tempStr += "<li class='next'><a href='javascript:void(0)' onClick=\"sw.page.modules['deliverymanage/seeDeliveryDetail'].goPage(" + (currentPage + 1) + "," + psize + ")\"> 下一页&nbsp;&nbsp;</a><li>";
        } else {
    ...
    init: function () {
        ...
        $("#ws-page-apply").click(function () {
            sw.page.modules["deliverymanage/seeDeliveryDetail"].saveExitInventoryInfo();
        });
