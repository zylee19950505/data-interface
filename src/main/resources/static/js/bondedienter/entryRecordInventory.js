//清单查询
sw.page.modules["bondedienter/entryRecordInventory"] = sw.page.modules["bondedienter/entryRecordInventory"] || {
    ...
    query: function () {
        ...
        // 数据表
        sw.datatable("#query-entryRecordInventory-table", {
            ordering: false,
            bSort: false, //排序功能
            ...
            columns: [
                ...
                {data: "bill_no", label: "备案清单编号"},//订单编号要点击查看订单详情
                {data: "logistics_no", label: "核注清单编号"},
                {data: "invt_no", label: "申报状态"},
                {
