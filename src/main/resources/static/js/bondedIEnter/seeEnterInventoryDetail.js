...
sw.page.modules["bondedIExit/seeEnterInventoryDetail"] = sw.page.modules["bondedIExit/seeEnterInventoryDetail"] || {
    detailParam: {
        url: "",
        callBackUrl: "",
        isShowError: true,
    ...
    init: function () {
        //从路径上获取参数
        var param = sw.getPageParams("detailmanage/seeEnterInventoryDetail");
        // var guid = param.guid;
        ...
        $("#ws-page-apply").click(function () {
            sw.page.modules["bondedIEnter/seeEnterInventoryDetail"].saveEntryInfo(orderNo, type, sw.ie);
        });
        //点击取消
        $("#ws-page-back").click(function () {
            sw.page.modules["bondedIEnter/seeEnterInventoryDetail"].cancel();
        });
    },
