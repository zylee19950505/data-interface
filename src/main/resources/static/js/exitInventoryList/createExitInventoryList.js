//清单查询
sw.page.modules["exitInventoryList/createExitInventoryList"] = sw.page.modules["exitInventoryList/createExitInventoryList"] || {
    ...
    query: function () {
        ...
        // 数据表
        sw.datatable("#query-createExitInventoryList-table", {
            ordering: false,
            bSort: false, //排序功能
            ...
            columns: [
                ...
                {data: "bill_no", label: "跨境清单编号"}//订单编号要点击查看订单详情
