...
},beforePageText:"Page",afterPageText:"of {pages}",displayMsg:"显示结果第{from}至{to}条 &nbsp;&nbsp;  共 {total} 条",nav:{first:{iconCls:"pagination-first",handler:function(){
...
if(opts.collapsible){
$("<a class=\"sssss\" href=\"javascript:void(0)\"></a>").appendTo(tool).bind("click",function(){
...
_89d(this,q);
}},currentText:"今天",closeText:"Close",okText:"确定",formatter:function(date){
