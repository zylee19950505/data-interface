...
public class ValidateEnterInstance extends ValidateBase {
    ...
    public void getIndexValue(List<String> list) {
        ...
        usecdIndex = list.indexOf(ExcelHeadEnterInventory.usecd);//原产国(地区)
        lvyrlf_modecdIndex = list.indexOf(ExcelHeadEnterInventory.lvyrlf_modecd);//原产国(地区)
    ...
    public void initMap() {
        ...
        indexMap.put(usecdIndex, "用途代码,6");
        indexMap.put(natcdIndex, "征免代码,6");
