...
//            impOrderHead.setNote(excelData.get(i).get(noteIndex));//备注
            ...
            impOrderHead.setGross_weight(getDouble(value.get(grossWeightIndex)));//毛重
            impOrderHead.setNet_weight(getDouble(value.get(netWeightIndex)));//净重
    ...
    public void getIndexValue(List<String> orderLists) {
        ...
        buyer_Id_NumberIndex = orderLists.indexOf(ExcelHeadBondOrder.buyer_Id_Number);//订购人证件号码
        ...
        consignee_AddressIndex = orderLists.indexOf(ExcelHeadBondOrder.consignee_Address);//收货地址
        ...
        originCountryIndex = orderLists.indexOf(ExcelHeadBondOrder.originCountry);//原产国
        grossWeightIndex = orderLists.indexOf(ExcelHeadBondOrder.grossWeight);//毛重
        netWeightIndex = orderLists.indexOf(ExcelHeadBondOrder.netWeight);//净重
