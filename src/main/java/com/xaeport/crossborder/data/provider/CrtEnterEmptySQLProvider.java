...
public class CrtEnterEmptySQLProvider extends BaseSQLProvider{

    public String queryCrtEnterEmptyList(Map<String, String> paramMap){
    ...
    public String queryCrtEnterEmptyCount(Map<String, String> paramMap){
        final String vehicle_no = paramMap.get("vehicle_no");
        final String start = paramMap.get("start");
        final String length = paramMap.get("length");
        final String entId = paramMap.get("entId");
    ...
    public String saveEntryEmptyInfo(@Param("passPortHead") PassPortHead passPortHead){
        return new SQL(){
            {
    ...
    public String updateEntryEmptyInfo(@Param("passPortHead") PassPortHead passPortHead){
        return new SQL(){
            {
    ...
    public String submitEmptyCustom(Map<String, String> paramMap){
