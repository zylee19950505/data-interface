...
public class AccountRecordSQLProvider extends BaseSQLProvider{
    ...
    public String queryAllAccountsInfo(Map<String, String> paramMap) {
        final String accountinfo = paramMap.get("accountinfo");
        final String crt_ent_id = paramMap.get("crt_ent_id");
        final String crt_ent_name = paramMap.get("crt_ent_name");
        ...
        return new SQL() {
            {
                ...
                if (!StringUtils.isEmpty(accountinfo)) {
                    WHERE("t.BWS_NO = #{accountinfo}");
                }
                WHERE("t.CRT_ENT_ID = #{crt_ent_id}");
                WHERE("t.CRT_ENT_NAME = #{crt_ent_name}");
            }
        }.toString();
    }
    ...
    public String accountUpdate(@Param("bwlHeadType") BwlHeadType bwlHeadType) throws Exception {
        return new SQL() {
            {
    ...
    public String crtAccountInfo(@Param("bwlHeadType") BwlHeadType bwlHeadType) throws Exception {
        return new SQL() {
            {
