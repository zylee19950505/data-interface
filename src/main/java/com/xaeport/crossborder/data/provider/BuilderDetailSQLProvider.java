...
public class BuilderDetailSQLProvider {

    public String findBuilderOrderNo(Map<String, String> paramMap){
        return new SQL(){
            {
                SELECT("t.ORDER_NO");
                FROM("T_BUILDER_CACHE t");
                WHERE("t.DATASTATUS = #{dataStatus}");
            }
        }.toString();
    }

    public String queryOrderHead(@Param("orderNo") String orderNo){
        return new SQL(){
            {
                SELECT("t.*");
    ...
    public String queryOrderList(@Param("orderNo") String orderNo){
        return new SQL(){
            {
                SELECT("t.*");
    ...
    public String queryLogistics(@Param("orderNo") String orderNo){
        return new SQL(){
            {
              SELECT("*");
    ...
    public String  queryBwsNoByEntId(@Param("ent_code") String ent_code, @Param("ent_name") String ent_name){
        return new SQL(){
            {
                SELECT("t.bws_no");
                FROM("T_BWL_HEAD_TYPE t");
                WHERE("t.CRT_ENT_ID = #{ent_code}");
                WHERE("t.CRT_ENT_NAME = #{ent_name}");
            }
        }.toString();
    }
    ...
    public String updateBuilderCacheByOrderNo(@Param("orderNo") String orderNo,@Param("dataStatus") String dataStatus){
