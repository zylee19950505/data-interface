...
public interface LogicalMapper {
    ...
    @SelectProvider(type = LogicalSQLProvider.class, method = "queryDeleteOrderByGuids")
    List<ImpCrossBorderHead> queryDeleteOrderByGuids(Map<String, String> paramMap);

    @SelectProvider(type = LogicalSQLProvider.class, method = "queryDeleteInventoryByGuids")
    List<ImpCrossBorderHead> queryDeleteInventoryByGuids(Map<String, String> paramMap);

    @SelectProvider(type = LogicalSQLProvider.class, method = "queryDeleteLogisticsByGuids")
    List<ImpCrossBorderHead> queryDeleteLogisticsByGuids(Map<String, String> paramMap);

    @SelectProvider(type = LogicalSQLProvider.class, method = "queryDeletePaymentByGuids")
