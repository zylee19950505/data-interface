...
import com.xaeport.crossborder.service.bondordermanage.BondOrderImpService;
...
//保税订单导入
@RestController
@RequestMapping("/bondordermanage")
public class BondOrderImpApi extends BaseApi {
    private Log log = LogFactory.getLog(this.getClass());
    @Autowired
    AppConfiguration appConfiguration;
    @Autowired
    BondOrderImpService bondOrderImpService;
    ...
    public ResponseData MultipartFile(
        ...
        try {
            ...
            if (map.containsKey("error")) {
                ...
                String orderNoCount = this.bondOrderImpService.getOrderNoCount(excelMap);
