...
public class CrtExitEmptyService {
    ...
    public PassPortHead queryPassportDetail(Map<String, String> paramMap) {
        return crtExitEmptyMapper.queryPassportDetail(paramMap);
    }
    ...
    public Map<String, String> saveExitEmptyInfo(LinkedHashMap<String, Object> object, Users users) {
        ...
        rtnMap.put("msg", "新建出区空车核放单成功！");
        return rtnMap;
    }

    //编辑出区空车核放单
    @Transactional
    public Map<String, String> updatePassport(LinkedHashMap<String, Object> object, Users users) {
        Map<String, String> rtnMap = new HashMap<>();
        PassPortHead passPortHead = new PassPortHead();
        ...
        passPortHead.setStatus(StatusCode.CQKCHFDDSB);//出区核放单待申报
        passPortHead.setUpd_user(users.getId());
        this.crtExitEmptyMapper.updatePassport(passPortHead);
        rtnMap.put("result", "true");
        rtnMap.put("msg", "修改出区空车核放单成功！");
        return rtnMap;
    }
