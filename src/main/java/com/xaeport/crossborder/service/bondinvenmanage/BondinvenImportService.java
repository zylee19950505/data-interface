 ...
 */
    private int createImpInventoryHead(Map<String, Object> excelMap, String importTime, Users user, String voyageNo, String billNo) throws Exception {
        ...
        for (ImpInventoryHead anImpInventoryHeadList : impInventoryHeadList) {
            ...
            this.bondinvenImportMapper.insertImpInventoryHead(impInventoryHead);//查询无订单号则插入ImpInventoryHead数据
    ...
    private void createImpInventoryList(Map<String, Object> excelMap, ImpInventoryHead impInventoryHead, Users user) throws Exception {
        ...
        for (int i = 0, len = list.size(); i < len; i++) {
            ...
            if (headOrder_no.equals(listOrder_no)) {
                ...
                count++;
                this.bondinvenImportMapper.insertImpInventoryBody(impInventoryBody);//插入EntryList数据
