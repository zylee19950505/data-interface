...
public class EnterPassPortDataLoader implements BondLoader {
    ...
    public List<ImpBDHeadVer> loadingData() {
        ...
        List<ImpBDHeadVer> impBDHeadVers = this.verificationMapper.unverifiedByPassPort(StatusCode.BSYDR, SystemConstants.BSRQ);
